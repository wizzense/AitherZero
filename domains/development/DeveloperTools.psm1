...
function Install-DeveloperTool {
    ...
    switch ($Tool) {
        ...
        'VSBuildTools' { return Install-VSBuildTools -Configuration $Configuration }
        'Poetry' { return Install-Poetry -Configuration $Configuration }
        'Sysinternals' { return Install-Sysinternals -Configuration $Configuration }
        'ClaudeCode' { return Install-ClaudeCode -Configuration $Configuration }
        'GeminiCLI' { return Install-GeminiCLI -Configuration $Configuration }
...
$aitherZeroModule = Join-Path $PSScriptRoot "AitherZero.psm1"
if (Test-Path $aitherZeroModule) {
    Import-Module $aitherZeroModule -Force -Global
}
