...
function Build-UnitTest {
    ...
    [void]$sb.AppendLine('        }')
    [void]$sb.AppendLine('')
    [void]$sb.AppendLine("        It 'Should adapt to CI environment' -Skip:(-not $script:TestEnv.IsCI) {")
    ...
    [void]$sb.AppendLine('        }')
    [void]$sb.AppendLine('')
    [void]$sb.AppendLine("        It 'Should adapt to local environment' -Skip:($script:TestEnv.IsCI) {")
