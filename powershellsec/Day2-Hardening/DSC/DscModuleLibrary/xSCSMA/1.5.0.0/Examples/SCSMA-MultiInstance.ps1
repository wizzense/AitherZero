...
$ConfigurationData = @{
    AllNodes = @(
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Service Management Automation Web Service Server")
        }
        @{
        ...
        @{
            ...
            Roles = @("System Center 2012 R2 Service Management Automation Runbook Worker Server")
        }
        @{
