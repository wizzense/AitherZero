...
try
{
    ...
    InModuleScope 'MSFT_ServiceResource' {
        ...
        Describe 'Service\Get-TargetResource' {
        ...
        Describe 'Service\Set-TargetResource' {
        ...
        Describe 'Service\Test-TargetResource' {
            Mock -CommandName 'Assert-NoStartupTypeStateConflict' -MockWith { }
        ...
        Describe 'Service\ConvertTo-StartupTypeString' {
        ...
        Describe 'Service\Assert-NoStartupTypeStateConflict' {
        ...
        Describe 'Service\ConvertTo-StartName' {
        ...
        Describe 'Service\Set-ServicePath' {
        ...
        Describe 'Service\Set-ServiceAccountProperty' {
        ...
        Describe 'Service\Set-ServiceStartupType' {
        ...
        Describe 'Service\Set-ServiceProperty' {
            $testServiceCimInstance = @{
                Description = 'Test service description'
                DisplayName = 'TestDisplayName'
            }
        ...
        Describe 'Service\Remove-ServiceWithTimeout' {
        ...
        Describe 'Service\Start-ServiceWithTimeout' {
        ...
        Describe 'Service\Stop-ServiceWithTimeout' {
