...
Remove-ADUser -Identity "cn=Justin McCarthy,ou=boston,ou=east_coast,dc=testing,dc=local"
...
Set-ADAccountExpiration -Identity "Justin" -DateTime "5/18/2019 6:00 AM"
