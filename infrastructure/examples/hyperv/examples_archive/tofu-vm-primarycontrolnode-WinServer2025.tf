...
resource "hyperv_vhd" "PrimaryControlNode-Server2025-vhd" {
...
resource "hyperv_machine_instance" "PrimaryControlNode-Server2025" {
  name                                    = "PrimaryControlNode-Server2025"
  generation                              = 2
  ...
  hard_disk_drives {
    ...
    path                            = hyperv_vhd.PrimaryControlNode-Server2025-vhd.path
