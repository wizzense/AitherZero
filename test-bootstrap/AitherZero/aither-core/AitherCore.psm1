...
# Fallback logging function for bootstrap phase
function Write-BootstrapLog {
    ...
    Write-Host "[$timestamp] [$Level] [CoreApp] $Message" -ForegroundColor $color
}

# Safe logging function that falls back when Write-CustomLog is not available
function Write-SafeLog {
    ...
    if (Get-Command Write-CustomLog -ErrorAction SilentlyContinue) {
        ...
        Write-BootstrapLog -Message $Message -Level $Level
    }
}
        ...
        process {
            ...
            foreach ($moduleInfo in $modulesToImport) {
                try {
                    ...
                    Write-SafeLog -Message "✓ Imported: $($moduleInfo.Name)" -Level 'SUCCESS'
                    ...
                    Write-SafeLog -Message "✗ Failed to import $($moduleInfo.Name): $($_.Exception.Message)" -Level 'ERROR'
            ...
            Write-SafeLog -Message "Module import complete: $($importResults.ImportedCount) imported, $($importResults.FailedCount) failed, $($importResults.SkippedCount) skipped" -Level 'INFO'
