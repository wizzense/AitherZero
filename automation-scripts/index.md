...
| `az 0010` | Idempotent setup and validation of MCP servers for GitHub Copilot |  |
...
| `az 0215` | Configure Model Context Protocol (MCP) servers for GitHub Copilot |  |
...
| `az 0219` | Install Chocolatey package manager for Windows |  |
...
| `az 0405` | Validates all PowerShell module manifest files in the project for Unicode and parsing issues | testing, validation, manifest, unicode |
...
| `az 0415` | Manage PSScriptAnalyzer cache for performance optimization |  |
| `az 0420` | Validate component quality for new features and components |  |
| `az 0425` | Validates and maintains documentation structure and organization |  |
| `az 0426` | Validate synchronization between test files and automation scripts |  |
...
| `az 0514` | Generate comprehensive interactive code map visualizer |  |
| `az 0515` | Deploy documentation and reports to GitHub Pages |  |
| `az 0516` | Schedule automatic report generation for AitherZero project |  |
...
| `az 0531` | Get detailed workflow run reports for CI debugging |  |
...
| `az 0746` | Orchestrated documentation generation - runs all doc generators | documentation, automation, orchestration, index |
| `az 0750` | Build the AitherZero MCP Server |  |
| `az 0751` | Start the AitherZero MCP Server |  |
| `az 0752` | Demonstrate AitherZero MCP Server functionality |  |
| `az 0753` | Actually USE the MCP Server to execute AitherZero commands |  |
| `az 0754` | Scaffolds a new Model Context Protocol (MCP) server using the AitherZero MCP server template |  |
...
---
*Generated automatically on 2025-11-05 19:21:12*
