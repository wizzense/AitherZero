...
Describe '0206_Install-Python' -Tag 'Unit', 'AutomationScript', 'Development' {

    BeforeAll {
        $script:ScriptPath = '/home/runner/work/AitherZero/AitherZero/automation-scripts/0206_Install-Python.ps1'
        $script:ScriptName = '0206_Install-Python'
    }
