...
Describe "0211_Install-VSBuildTools" {
    BeforeAll {
        Import-Module Pester -Force
        
        $scriptPath = Join-Path (Split-Path (Split-Path (Split-Path (Split-Path $PSScriptRoot -Parent) -Parent) -Parent) -Parent) "automation-scripts/0211_Install-VSBuildTools.ps1"
