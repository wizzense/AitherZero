...
.DESCRIPTION
    ...
    Description: Automatically discovers and synchronizes all inventory in config.psd1:
...
Describe '0003_Sync-ConfigManifest' -Tag 'Unit', 'AutomationScript', 'Environment Setup' {
    ...
    BeforeAll {
        ...
        $script:ScriptPath = Join-Path $repoRoot 'library/automation-scripts/0003_Sync-ConfigManifest.ps1'
