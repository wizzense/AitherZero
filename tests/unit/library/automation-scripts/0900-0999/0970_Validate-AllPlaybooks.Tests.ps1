...
<#
.SYNOPSIS
    Unit tests for 0970_Validate-AllPlaybooks
.DESCRIPTION
    Auto-generated comprehensive tests with environment awareness
    Script: 0970_Validate-AllPlaybooks
    Stage: Unknown
    Description: This script performs comprehensive validation of ALL playbooks in AitherZero:
    Supports WhatIf: True
    Generated: 2025-11-10 16:41:57
#>

Describe '0970_Validate-AllPlaybooks' -Tag 'Unit', 'AutomationScript', 'Unknown' {
    ...
    BeforeAll {
        ...
        $script:ScriptName = '0970_Validate-AllPlaybooks'
    ...
    Context 'Parameters' {
        It 'Should have parameter: PlaybookDirectory' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('PlaybookDirectory') | Should -Be $true
        }
        ...
        It 'Should have parameter: StopOnFirstError' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('StopOnFirstError') | Should -Be $true
        }

        It 'Should have parameter: GenerateMarkdownReport' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('GenerateMarkdownReport') | Should -Be $true
        }
