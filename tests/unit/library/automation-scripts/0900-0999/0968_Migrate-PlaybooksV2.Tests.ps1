...
.DESCRIPTION
    ...
    Script: 0968_Migrate-PlaybooksV2
    Stage: Quality
    Description: This script helps convert existing v1 playbooks to the new v2.0 standardized format.
    Supports WhatIf: False
    Generated: 2025-11-10 16:41:57
#>

Describe '0968_Migrate-PlaybooksV2' -Tag 'Unit', 'AutomationScript', 'Quality' {
    ...
    BeforeAll {
        ...
        $script:ScriptName = '0968_Migrate-PlaybooksV2'
    ...
    Context 'Parameters' {
        It 'Should have parameter: InputPath' {
