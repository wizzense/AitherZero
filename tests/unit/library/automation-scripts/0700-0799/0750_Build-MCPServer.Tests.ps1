...
Describe '0750_Build-MCPServer' -Tag 'Unit', 'AutomationScript', 'AI Tools & Automation' {
    ...
    BeforeAll {
        ...
        $script:ScriptPath = Join-Path $repoRoot 'library/automation-scripts/0750_Build-MCPServer.ps1'
        $script:ScriptName = '0750_Build-MCPServer'
    ...
    Context 'Parameters' {
        It 'Should have parameter: Clean' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('Clean') | Should -Be $true
        }
