...
<#
.SYNOPSIS
    Unit tests for 0195_Inject-ISO-Artifacts
.DESCRIPTION
    Auto-generated comprehensive tests with environment awareness
    Script: 0195_Inject-ISO-Artifacts
    Stage: Infrastructure
    Description: This script automates the injection of AitherZero configuration artifacts into
    Supports WhatIf: True
    Generated: 2025-11-10 16:41:55
#>

Describe '0195_Inject-ISO-Artifacts' -Tag 'Unit', 'AutomationScript', 'Infrastructure' {
    ...
    BeforeAll {
        ...
        $script:ScriptName = '0195_Inject-ISO-Artifacts'
    ...
    Context 'Parameters' {
        It 'Should have parameter: IsoPath' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('IsoPath') | Should -Be $true
        }
        ...
        It 'Should have parameter: ArtifactPath' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('ArtifactPath') | Should -Be $true
        }

        It 'Should have parameter: BootstrapScript' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('BootstrapScript') | Should -Be $true
        }

        It 'Should have parameter: Validate' {
            $cmd = Get-Command $script:ScriptPath
            $cmd.Parameters.ContainsKey('Validate') | Should -Be $true
        }
