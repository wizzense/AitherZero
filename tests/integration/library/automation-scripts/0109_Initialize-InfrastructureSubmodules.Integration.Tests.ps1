...
<#
.SYNOPSIS
    Integration tests for 0109_Initialize-InfrastructureSubmodules
.DESCRIPTION
...
Describe '0109_Initialize-InfrastructureSubmodules Integration' -Tag 'Integration', 'AutomationScript' {
