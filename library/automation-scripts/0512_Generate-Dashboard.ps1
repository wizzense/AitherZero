...
Test results are aggregated from TestReport-*.json files in library/tests/results.
...
function Get-CodeCoverageDetails {
    ...
    if ($latestCoverage) {
        ...
        Write-ScriptLog -Level Warning -Message "No coverage files found in library/tests/results or library/tests/coverage"
    }
