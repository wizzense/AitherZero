...
**Use Case**: All current JSON playbooks in `/aithercore/orchestration/playbooks/`  
...
```json
// File: aithercore/orchestration/playbooks/core/operations/ci-pr-validation.json
...
```json
// File: aithercore/orchestration/playbooks/converted/test-workflow.json
...
- **Examples**: All existing playbooks in `aithercore/orchestration/playbooks/`
