...
Describe "0523_Analyze-SecurityIssues" {
    BeforeAll {
        ...
        } elseif ("0523_Analyze-SecurityIssues" -eq "0523_Analyze-SecurityIssues") {
            Mock -CommandName Get-FilesToAnalyze -MockWith {
                @(@{ FullName = "TestScript.ps1" })
            }
            Mock -CommandName Get-Content -MockWith {
        ...
        } elseif ("0523_Analyze-SecurityIssues" -eq "0524_Generate-TechDebtReport") {
    ...
    Context "Parameter Validation" {
        ...
        if ("0523_Analyze-SecurityIssues" -eq "0524_Generate-TechDebtReport") {
    ...
    Context "Analysis Execution" {
        ...
        if ("0523_Analyze-SecurityIssues" -ne "0524_Generate-TechDebtReport") {
