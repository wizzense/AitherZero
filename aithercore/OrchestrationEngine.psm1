...
# Initialize module - assume aithercore is at project root level
$script:AitherCoreRoot = $PSScriptRoot
...
# Import logging from aithercore
$script:LoggingAvailable = $false
try {
    $loggingPath = Join-Path $script:AitherCoreRoot "Logging.psm1"
